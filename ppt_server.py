    ...
    while True:
        ...
        while True:
            ...
            if smsg.split("@")[0] == "open_ppt": 
                ...
                os.system('start /max "" "POWERPNT.EXE" /S '+"C:/Users/Mediadone/Desktop/projet_clean/turbo-octo-guacamole/"+ppt)  # /s slide show C:\\Program Files (x86)\\Microsoft Office\\root\\Office16\\
